...
sudo apt-get -y install -y python3 python3-dev python3-pip odroid-wiringpi libwiringpi-dev apparmor-utils
...
./GCFFlasher -d /dev/ttyS1 -t 60 -f deCONZ_RaspBeeII_0x26780700.bin.GCF
cd ..
